...
//       act.click(driver.findElement(By.xpath("//*[text()='company']"))).perform();
//
//       driver.findElement(By.xpath("(//*[text()='Contact'])[1]")).click();
//
//       System.out.println("\nContact Page Address:\n"+driver.findElement(By.xpath("//span[@class='dark']")).getText());
//
//      driver.navigate().back();

//        act.moveToElement(driver.findElement(By.xpath("//div[@id='livechat-eye-catcher']"))).perform();
//
//        driver.findElement(By.xpath("//div[@id='livechat-eye-catcher']/div[1]")).click();
...
//
//        driver.findElement(By.xpath("//button[@class='e1mwfyk10 lc-4rgplc e1m5b1js0']")).click();
//
